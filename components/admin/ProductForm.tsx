...
import { UploadButton } from "@/lib/validators/uploadthing";
      ...
      >
              ...
              <FormItem className="w-full">
                ...
                <FormControl>
                  <div className="flex flex-row items-center gap-2">
                    ...
                    <Button
                      type="button"
                      className="bg-gray-500 hover:bg-gray-600 text-white px-3 py-1 cursor-pointer"
                      onClick={() => {
                        form.setValue(
                          "slug",
        ...
        <div className="upload-field flex flex-col md:flex-row gap-5">
          ...
          <FormField
            ...
            render={() => (
              <FormItem className="w-full">
                <FormLabel className="mb-1">Images</FormLabel>
                <Card>
        ...
        <div className="upload-field">
          {/* Is Featured */}
          <div className="mb-2">Featured Product</div>
          <Card>
